...
@author: awagh
"""
# THIS CONTAINS CODE FOR CALCULATING THE BUSBAR SOLUTION AND CABLE SOLUTION REQUIRED FOR AN APARTMENT DESIGN
# ACCORDINGLY IT COMPARES THE COST OF THE TWO DESIGNS
# INITIALLY ASSUMING NO FIRE CHECK AND SERVICE AREAS

""" 
PARAMETERS REQUIRED :
    1) Length of each floor, Podium Height, Horizontal run, Length of apartments
    2) Additional lengths (if any or type 'done')
    3) No. of transformers used and the levels they supply power to -> Dictionary containing transformer no. ; Start Level ; End Level
"""
import Excel_killer
 
horizontal = input("Length of Horizontal run : ")
